...
vim.keymap.set({ 'n', 'v' }, '<C-m>', vim.diagnostic.open_float)
vim.keymap.set('n', '<Tab>', '<Cmd>BufferLineCycleNext<CR>', {})
vim.keymap.set('n', '<S-Tab>', '<Cmd>BufferLineCyclePrev<CR>', {})
vim.keymap.set('n', '<leader>x', '<Cmd>bdelete<CR>', { desc = 'Close current buffer' })
vim.keymap.set({ 'n', 'v' }, '<C-s>', '<Cmd>w<CR>', { desc = 'Save current buffer' })
...
require('lazy').setup({
  ...
  { 'NMAC427/guess-indent.nvim', cond = not vim.g.vscode }, -- Detect tabstop and shiftwidth automatically
  ...
  { 'folke/todo-comments.nvim', cond = not vim.g.vscode, event = 'VimEnter', dependencies = { 'nvim-lua/plenary.nvim' }, opts = { signs = false } },
